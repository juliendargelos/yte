...
const _lazy_jC77s1 = () => import('../pool.mjs');
const _lazy_fHO9Tp = () => import('../handlers/renderer.mjs');

const handlers = [
  { route: '/api/pool', handler: _lazy_jC77s1, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_fHO9Tp, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_fHO9Tp, lazy: true, middleware: false, method: undefined }
];
